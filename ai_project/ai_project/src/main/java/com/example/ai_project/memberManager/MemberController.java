...
public class MemberController {
    ...
    private final com.example.ai_project.memberManager.SignService signupservice;

    public MemberController(com.example.ai_project.memberManager.SignService signupservice) {
